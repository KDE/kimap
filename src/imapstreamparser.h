...
/*!
  ...
  \brief Parser for IMAP messages that operates on a local socket stream.
*/
...
public:
     ...
     *
     * If the upcoming data is not a quoted string, unquoted string or a literal,
     ...
     *
     * If the upcoming data is not a parenthesized list,
     ...
     * This call might block.
     *
     * Returns \c true if a string follows
     */
    bool hasString();
     ...
     * This call might block.
     *
     * Returns \c true if a literal follows
     */
    bool hasLiteral();
     ...
     *
     * This might or might not be the full data.
     *
     ...
     *
     * Returns \c true if the literal was completely read.
     */
     ...
     * This call might block.
     *
     * Returns \c true if a parenthesized list comes.
     */
    bool hasList();
     ...
     * This call might block.
     *
     * Returns \c true if a parenthesized list end.
     */
    bool atListEnd();
     ...
     * This call might block.
     *
     * Returns \c true if a response code comes.
     */
     ...
     * This call might block.
     *
     * Returns \c true if a response code end.
     */
     ...
     *
     * Returns \c true if the end of command is reached
     */
    bool atCommandEnd();
