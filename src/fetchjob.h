...
Q_SIGNALS:
     ...
     *
     * \a mailBox  the name of the mailbox the fetch job was
     *                 executed on
     * \a uids     a map from message sequence numbers to message UIDs;
     *                 this will always be populated
     * \a sizes    a map from message sequence numbers to message sizes
     *                 (sizes are in octets and refer to the transfer encoding of
     *                 the message); populated if the scope is FetchScope::Full or
     *                 FetchScope::Headers
     * \a flags    a map from message sequence numbers to message flags;
     *                 populated if the scope is FetchScope::Flags, FetchScope::Full
     *                 of FetchScope::Headers
     * \a messages a map from message sequence numbers to message contents (including
     ...
     * \a uids     a map from message sequence numbers to message UIDs;
     *                 this will always be populated
     * \a attrs    a map from message sequence numbers to a pair of attribute
     *                 name and value
     * \a sizes    a map from message sequence numbers to message sizes
     *                 (sizes are in octets and refer to the transfer encoding of
     *                 the message); populated if the scope is FetchScope::Full or
     ...
     *                 executed on
     * \a uids     a map from message sequence numbers to message UIDs
     * \a messages a map from message sequence numbers to message contents
     *
     * \deprecated Use messagesAvailable() instead.
     */
    KIMAP_DEPRECATED
     ...
     *                 executed on
     * \a uids     a map from message sequence numbers to message UIDs
     * \a attrs    a map from message sequence numbers to pair of attribute
     *                 name and it's value
     * \a messages a map from message sequence numbers to message contents
     *
     * @overload
     ...
     *                 executed on
     * \a uids     a map from message sequence numbers to message UIDs
     * \a parts    a map from message sequence numbers to message part collections
     *
     * \deprecated Use messagesAvailable() instead.
     */
    KIMAP_DEPRECATED
